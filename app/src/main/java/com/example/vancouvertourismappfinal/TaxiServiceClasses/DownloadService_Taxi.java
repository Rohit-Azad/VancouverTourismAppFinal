 ...
 */
public class DownloadService_Taxi extends IntentService {
    String params;
    String site="http://ec2-54-175-146-67.compute-1.amazonaws.com:8000";

    // required to have a constructor
    public DownloadService_Taxi() {
        super(DownloadService_Taxi.class.getName());
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if(intent.getStringExtra("loginOrRegister").equals("EnterReservation")) {
            String fields[] = {"passengers", "address1", "address2", "ID", "priceperhour", "taxi", "name", "pickup", "loginOrRegister"};
            params = putParamTogether(fields,intent);
        }
        else {
            String fields[] = {"SeatingCapacity", "loginOrRegister"};
            params = putParamTogether(fields,intent);
        }
      //  params = putParamTogether(fields,intent);
        ...
        // do some work
       // String site = "http://ec2-100-24-58-152.compute-1.amazonaws.com:8000";
        ...
        broadcast.setAction(DBConnectivity_Taxi.STATUS_DONE);
       // Log.d("id",results);
