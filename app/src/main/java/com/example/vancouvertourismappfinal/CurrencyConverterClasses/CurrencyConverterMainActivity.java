...
import com.example.vancouvertourismappfinal.CurrencyConverterClasses.service.CurrencyConverterService;
import com.example.vancouvertourismappfinal.CurrencyConverterClasses.service.CurrencyConverterServiceImpl;
...
public class CurrencyConverterMainActivity extends AppCompatActivity {
    Button n0;
    Button n1;
    Button n2;
    Button n3;
    ...
    private void setupListeners() {
        ...
        from.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(CurrencyConverterMainActivity.this, from);
        ...
        to.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(CurrencyConverterMainActivity.this, to);
                popupMenu.getMenuInflater().inflate(R.menu.menufrom, popupMenu.getMenu());
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem menuItem) {
    ...
    private void convert() {
        ...
        if (fromtext.equals(totext)) {
            Toast.makeText(CurrencyConverterMainActivity.this, "From and to Values are Same", Toast.LENGTH_SHORT).show();
            return;
        } else if (fromt.getText().toString().isEmpty()) {
            Toast.makeText(CurrencyConverterMainActivity.this, "Please Enter a Value", Toast.LENGTH_SHORT).show();
            return;

        }

        if (!isConnected()) {
            Toast.makeText(CurrencyConverterMainActivity.this, "No Internet Connection or Host Unreachable", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void setupViews() {
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(CurrencyConverterMainActivity.this, MainActivity_1.class);
                startActivity(i);
            }
        });
        ...
        from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(CurrencyConverterMainActivity.this, from);
                popupMenu.getMenuInflater().inflate(R.menu.menufrom_1, popupMenu.getMenu());
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        from.setText(menuItem.getTitle().toString().substring(menuItem.getTitle().toString().length() - 3));
    ...
    public void input(View view) {
        ...
        if (currentText.indexOf('.') == -1) {
            ...
            if (btn.getText().toString().equals(".")) {
                Toast.makeText(CurrencyConverterMainActivity.this, "Multiple Decimal Points Cannot Exist", Toast.LENGTH_SHORT).show();
            } else
                fromt.append(btn.getText().toString());
        }
    }
