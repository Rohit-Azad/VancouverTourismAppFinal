 ...
 */
public class DownloadService_Tourist extends IntentService {

    String site="http://ec2-54-175-146-67.compute-1.amazonaws.com:8000";


    // required to have a constructor
    public DownloadService_Tourist() {
        super(DownloadService_Tourist.class.getName());
    }


    @Override
    protected void onHandleIntent(Intent intent) {
        String fields[] = {"Location","loginOrRegister"};
        String params = putParamTogether(fields,intent);

        Log.d("how params look like",params);

        // do some work
     //   String site = "http://ec2-52-205-253-115.compute-1.amazonaws.com:8000";
        ...
        broadcast.setAction(DBConnectivity_Tourist.STATUS_DONE);
       // Log.d("id",results);
